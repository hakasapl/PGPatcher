                 ...
                 style)
{
    ...
    Bind(wxEVT_MENU, &PGModifiableListCtrl::onAddItem, this, static_cast<int>(ContextMenu::AddItem));
    Bind(wxEVT_MENU, &PGModifiableListCtrl::onRemoveItem, this, static_cast<int>(ContextMenu::RemoveItem));
}
...
{
    wxMenu menu;
    menu.Append(static_cast<int>(ContextMenu::AddItem), pgTr("components.modifiableList.add"));
    auto* removeItem = menu.Append(static_cast<int>(ContextMenu::RemoveItem), pgTr("components.modifiableList.remove"));
