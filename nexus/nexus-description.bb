...
From a texture mod author perspective, PGPatcher allows you to ship ONLY textures with your mod and nothing else (including plugins for alternate textures. PGPatcher will patch that for you too). You don't have to deal with prepatching any meshes, and the user can use your textures on their own meshes. Should be a win-win all around. More information for mod authors can be found [url=https://github.com/hakasapl/PGPatcher/wiki/Mod-Authors]here[/url].

As a user I understand the reluctance to learn and use yet another external tool. I always try to make things as easy and clear as possible and UX is a primary focus of mine for this reason. I hope the [url=https://github.com/hakasapl/PGPatcher/wiki]wiki[/url] is helpful for you. That being said I always look for feedback either here on nexus posts or in the form of a [url=https://github.com/hakasapl/PGPatcher/issues]GitHub issue[/url] if you feel there is something that could be clearer. You can also find me on the [url=https://www.nexusmods.com/skyrimspecialedition/mods/86492]Community Shaders[/url] discord.
